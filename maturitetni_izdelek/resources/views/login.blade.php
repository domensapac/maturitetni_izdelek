          ...
          <div class="row g-0">
              ...
              <div class="card-body p-md-5 mx-md-4">
                ...
                <form method="POST" action="{{ route('login.post') }}">
                  ...
                  <div class="text-center pt-1 mb-5 pb-1">
                    <a class="text-muted" href="#!">Pozabljeno geslo?</a>
                  </div>
                </form>
              </div>
            </div>
            <div class="col-lg-6 d-flex align-items-center gradient-custom-2">
              <div class="text-white px-3 py-4 p-md-5 mx-md-4">
                <h4 class="mb-4">Hitro in enostavno do malice!</h4>
                <p class="small mb-0">Naša aplikacija omogoča učencem enostaven prevzem šolske malice. Preprosto skenirajte svojo QR kodo in prevzemite obrok brez zamud. S tem poskrbimo za hitrejši potek delitve malice ter večjo preglednost in učinkovitost. Prijavite se in uživajte!</p>
              </div>
            </div>
          </div>
        </div>
